...
public class PlayerWarrior : Player
{
    ...
    [Tooltip(
        "Tempo em que o jogador fica com velocidade reduzida e direção travada após o hit melee."
    )]
    public float meleeHitMovementLockDuration = 0.5f;
    ...
    private void StartMeleeAttack()
    {
        ...
        ApplyHitEffect(meleeHitMovementLockDuration, 0.25f, true);
